 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.aqkiiz_app.staging
 */

const BUNDLE_ID = 'com.aqkiiz.app'; // ios bundle id
const PACKAGE = 'com.aqkiiz_app'; // android package name
const NAME = 'Aqkiiz'; // app name
const EXPO_ACCOUNT_OWNER = 'expo-owner'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'Aqkiiz_app'; // app scheme
